...
The `create_repo_ref()` documentation and the basic usage vignette describes how to specify the name of the environment variable you wish to use if it is not the default `GITHUB_PAT`.
