...
- [`ghclass`](https://github.com/rundel/ghclass/tree/master/R) is very similar in spirit. This package shares the goal of making a particular GitHub workflow easier. However, the workflow it is built to optimize is classroom management. 
