...
`ghtrackr` can play along with `reprex` by facilitating posting reprexes to repos as well as pulling them back down to evaluate them.
...
Suppose you see on GitHub that a user posted an issue, say number 82, with a reprex. Admittedly, you could just copy this directly from GitHub like a sane person. However, should you wish to do this with `ghtrackr`, you can!
